...
if __name__ == "__main__":
    ...
    recipe_repo.create(Recipe("c", "c", "Bacalhau a Milanesa", "500g de bacalhau|100ml de agua|20g de manteiga] Tudo dento, mistura numa cumbuca e come", 0, datetime.today()))
